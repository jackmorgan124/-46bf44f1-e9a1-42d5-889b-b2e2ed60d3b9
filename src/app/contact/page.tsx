...
export const metadata: Metadata = {
  ...
  description:
    'Get a free, obligation-free landscaping quote from Harris Landscaping & Gardens. Serving Campbelltown, Camden, Narellan, Picton and the wider South-West Sydney region.',
};
